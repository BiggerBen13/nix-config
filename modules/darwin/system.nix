  ...
  system = {
    ...
    defaults = {
      ...
      dock = {
        autohide = true;
        show-recents = false;
        mru-spaces = false; # Sort space by most recently used
      ...
      # copied from https://github.com/ryan4yin/nix-config/blob/6bbd73c2452136824890ec4061d3f35fce98154e/modules/darwin/system.nix#L190
      NSGlobalDomain = {
